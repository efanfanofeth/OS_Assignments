...
public class East_village implements Runnable
{
   ...
   public East_village(int vill, Semaphore RoadControl)
   {
   ...
   public void run()
   {
      ...
      synchronized (roadController) 
      {
         ...
         System.out.println("East_villager_" + villager_number + " is traveling on the road.");
         System.out.println("East_villager_" + villager_number + " is" + task[(int) (Math.random()*task.length)]);
         System.out.println("East_villager_" + villager_number + " Has Finished the exchange.");
